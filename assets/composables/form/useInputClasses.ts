...
const defaultInputClasses =
    'focus:outline focus:outline-offset-2 focus:outline-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5'
